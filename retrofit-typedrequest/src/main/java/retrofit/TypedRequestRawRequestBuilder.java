...
final class TypedRequestRawRequestBuilder {
  ...
  TypedRequestRawRequestBuilder(HttpUrl url, TypedRequest request,
  ...
  private void addBody() {
    ...
    if (body instanceof RequestBody) {
      ...
      //noinspection unchecked
      Converter<Object> converter = (Converter<Object>) converterFactory.get(body.getClass());
      this.body = converter.toBody(body);
    }
  }
